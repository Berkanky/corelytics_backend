...
if (!ACCESS_TOKEN_SECRET_KEY || ACCESS_TOKEN_SECRET_KEY.length < 32) {
  throw new Error("ACCESS_TOKEN_SECRET_KEY weak or undefined.");
}
...
function control_access_token(req, res, next) {
  try {
    ...
    var payload = jwt.verify(token, ACCESS_TOKEN_SECRET_KEY, {
