...
var { ACCESS_TOKEN_SECRET_KEY, JWT_TOKEN_ALGORITHM, ISSUER, AUDIENCE } = process.env;

if (!ACCESS_TOKEN_SECRET_KEY || ACCESS_TOKEN_SECRET_KEY.length < 32) throw new Error('ACCESS_TOKEN_SECRET_KEY weak or undefined. ');
...
var create_access_token = async (req, res, user_id, expires_in, session_id) => {
  ...
  try{
    ...
    var access_token = jwt.sign( payload, ACCESS_TOKEN_SECRET_KEY, options);
